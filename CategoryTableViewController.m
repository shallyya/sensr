...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"ProjectListFromCategory"]) {
        NSIndexPath *indexPath = [self.tableView indexPathForSelectedRow];
        ProjectListTableViewController *projectViewController = segue.destinationViewController;
        projectViewController.category = [[categories objectAtIndex:indexPath.row] objectForKey:@"category"];
    }
}
